    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-32">
      ...
      {selectedImage && (
        <Dialog
          ...
          overlayClassName="fixed inset-0 bg-stone-900/95 z-[200] flex items-center justify-center p-4 animate-in fade-in duration-300"
          panelClassName="relative w-full max-w-6xl aspect-[3/2]"
        >
            <button
