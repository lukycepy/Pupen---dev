...
export const SITE_PAGES: SitePageRegistryItem[] = [
  ...
  { slug: 'archiv', group: 'Nástroje', toolKey: 'archive', defaults: { enabled: true, tools: true } },
  { slug: 'galerie', group: 'Nástroje', toolKey: 'gallery', defaults: { enabled: true, tools: true } },
  { slug: 'daruj', group: 'Nástroje', toolKey: 'donate', defaults: { enabled: true, tools: true } },
  { slug: 'partnerstvi', group: 'Nástroje', toolKey: 'partnership', defaults: { enabled: true, tools: true } },
